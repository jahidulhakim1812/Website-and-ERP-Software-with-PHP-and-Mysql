...
<head>
  ...
  <title>Shipping & Returns — Ali Hair Wigs</title>
...
<main class="page-inner" role="main">
  <div class="hero">
    ...
    <p class="lead">Clear, fair shipping and returns so you can shop with confidence.</p>
  </div>

  <section class="section">
    <h2 style="font-weight:800;margin-bottom:8px">Shipping Overview</h2>
    <p class="muted">We offer reliable shipping across Bangladesh and international delivery options. Orders are processed within 1–2 business days and dispatched via our trusted couriers.</p>
    <ul style="margin-top:10px;color:#6b7280">
      <li><strong>Processing:</strong> 1–2 business days after order confirmation.</li>
      <li><strong>Domestic delivery:</strong> Typically 2–5 business days depending on your location.</li>
      <li><strong>International delivery:</strong> Varies by destination; please allow 7–21 business days.</li>
      <li><strong>Tracking:</strong> Tracking number provided when your order ships.</li>
    </ul>
  </section>

  <section class="section">
    <h2 style="font-weight:800;margin-bottom:8px">Shipping Costs</h2>
    <p class="muted">Shipping costs are calculated at checkout based on weight, dimensions, and destination. Free shipping promotions may apply for qualifying orders.</p>
  </section>

  <section class="section">
    <h2 style="font-weight:800;margin-bottom:8px">Return Policy</h2>
    <p class="muted">We accept returns within 14 days of delivery for unworn, unwashed products in original condition with tags. To start a return, contact our support team and provide your order number and reason for return.</p>
    <ul style="margin-top:10px;color:#6b7280">
      <li><strong>Eligibility:</strong> Items must be in original condition with tags and packaging.</li>
      <li><strong>Non-returnable:</strong> Custom orders, final sale items, or hygiene-sensitive products where seal has been broken.</li>
      <li><strong>Return shipping:</strong> Customer is responsible for return postage unless the item was defective or we made an error.</li>
      <li><strong>Refunds:</strong> Processed to the original payment method within 5–10 business days of receiving the returned item.</li>
    </ul>
  </section>

  <section class="section">
    <h2 style="font-weight:800;margin-bottom:8px">Exchanges & Replacements</h2>
    <p class="muted">If you need a different size, color, or a replacement for a damaged item, contact us. We'll help arrange an exchange or replacement where possible.</p>
  </section>

  <section class="section" style="display:flex;gap:16px;flex-wrap:wrap;align-items:center">
    <div style="flex:1;min-width:240px">
      <h3 style="margin:0 0 8px;font-weight:800">Need help with an order?</h3>
      <p class="muted">Contact our support team with your order number and we'll guide you through shipping, tracking, or returns.</p>
    </div>
    <div style="min-width:200px">
      <a href="contact.php" class="submit-btn" style="display:inline-block;background:var(--primary);color:#fff;padding:10px 14px;border-radius:8px;font-weight:700;text-decoration:none">Contact Support</a>
    </div>
  </section>
</main>

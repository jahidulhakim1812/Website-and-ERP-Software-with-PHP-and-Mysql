 ...
 * Single file solution with updated Header User Profile & Dropdown.
 */
...
// Mock Auth (Replace with your actual checks)
...
$stmt = $pdo->query("SELECT * FROM customers WHERE status = 'Active' ORDER BY created_at DESC");
$active_customers = $stmt->fetchAll();
$total_count = count($active_customers);
...
<head>
    ...
    <title>Active Customers | NexusAdmin</title>
...
<body>
    ...
    <div style="display: flex; align-items: center; gap: 16px;">
        ...
        <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <span style="font-size: 0.9rem; color: var(--text-muted);">Active Customers</span>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="header-title">
                        <h3>Active List</h3>
                        <span id="resultCount">Showing <?php echo $total_count; ?> active customer(s)</span>
                    </div>
                    <div class="toolbar">
                        <div class="search-box">
                            <i class="ph ph-magnifying-glass"></i>
                            <input type="text" id="searchInput" class="search-input" placeholder="Search active users...">
                        </div>
                        <button onclick="exportTableToCSV('active_customers.csv')" class="btn-export">
    ...
    <script>
        ...
        if(searchInput && tableBody) {
            searchInput.addEventListener('keyup', function() {
                ...
                if(resultCountSpan) resultCountSpan.innerText = `Showing ${visibleCount} active customer(s)`;
            });
        }

...
<head>
  ...
  <title>Our Mission — Ali Hair Wigs</title>
...
<main class="page-inner" role="main">
  <div class="hero">
    <h1>Our Mission</h1>
    <p class="lead">At Ali Hair Wigs we are committed to providing premium hairpieces that empower confidence, comfort, and style.</p>
  </div>

  <section class="section">
    <h2 style="font-weight:800;margin-bottom:8px">Quality and Craftsmanship</h2>
    <p class="muted">We source high-grade human hair and advanced synthetic fibers, and each piece is crafted and inspected to meet strict quality standards. Our focus is natural appearance, durability and comfortable wear.</p>
  </section>

  <section class="section">
    <h2 style="font-weight:800;margin-bottom:8px">Customer First</h2>
    <p class="muted">We prioritize your experience — from product selection and styling advice to fast shipping and responsive aftercare. Our customer support team helps match the right product to your needs and lifestyle.</p>
  </section>

  <section class="section">
    <h2 style="font-weight:800;margin-bottom:8px">Sustainable & Ethical Sourcing</h2>
    <p class="muted">We work with ethical suppliers and aim to reduce waste by offering modular products, responsible packaging and careful inventory management.</p>
  </section>

  <section class="section">
    <h2 style="font-weight:800;margin-bottom:8px">Community & Education</h2>
    <p class="muted">We support stylists and salon partners through training, private-label options and reliable supply lines — helping professionals grow their business and better serve clients.</p>
  </section>

  <section class="section" style="display:flex;gap:16px;flex-wrap:wrap;align-items:center">
    <div style="flex:1;min-width:240px">
      <h3 style="margin:0 0 8px;font-weight:800">Want to partner with us?</h3>
      <p class="muted">For wholesale, private-label or salon collaborations, get in touch and our business team will follow up promptly.</p>
    </div>
